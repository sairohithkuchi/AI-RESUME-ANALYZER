...
def run():
    ...
    img = Image.open("C:/Users/lenovo/Downloads/AI-Resume-Analyzer-main/App/Logo/updatedone.jpg")
    st.image(img)
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            ...
            <a href="https://www.linkedin.com/in/sai-rohith-kuchi-0544a5216/" style="text-decoration: none; color: grey;">SAI ROHITH KUCHI</a>
        </p>
